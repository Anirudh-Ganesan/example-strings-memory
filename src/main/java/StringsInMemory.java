public class StringsInMemory {
    public static void main(String[] args){
        //primitive data types overwrite memory locations
        ...
        //Strings are not primitives the values does not exist at the same
        //memory location
        //instead a reference to another location is what we find in the name location

        //Strings are also immutable which means once they are created
        //they cannot be changed
        //if they are changed actually
        //create a new memory location instead of overwriting
        ...
        //assigned a String variable to another String variable
        //they end up pointing to the same memory location
        ...
        secondString = "Ogres are like onions";
        System.out.println();

        //when using the keyword "new String"
        //to make a String you force Java
        //to make a String in a new memory
        //location this happens even if the value of the String is identical
        //to on that already exists
